  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return GestureDetector(
      onTap: () async {
        ...
        final result = await NavigationUtil.pushFromBottom<int?>(
          context,
          DetailRecipePage(recipe: recipe, category: displayCategory),
        );
        // Always refresh the latest user rating after returning from detail page
        await viewModel.refreshUserRatingForRecipe(
          recipe.id,
